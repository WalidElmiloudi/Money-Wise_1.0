...
<body class="w-full h-screen bg-slate-200 font-['open_sans'] overflow-hidden">
  ...
  <section class="w-full h-screen flex flex-col justify-center items-center xl:flex-row xl:px-15 px-2 gap-6  ">
    ...
    <div class="xl:order-1 flex flex-col items-center xl:items-start gap-5 xl:gap-8">
      <p class="text-center text-3xl font-bold text-[#041368] xl:text-start xl:text-6xl 2xl:text-7xl">Visualize your money flow and stick to your budget with
  ...
  <section id="loginModal"
    ...
    <div class="w-80 h-100 xl:w-120 xl:h-140 bg-slate-100 rounded-md flex justify-center items-center flex-col gap-4 xl:gap-8">
      ...
      <form action="" class="flex flex-col justify-center items-center gap-2 xl:gap-4">
        <input class="text-xl py-1 pl-1 pr-5 bg-white rounded-md text-[#041368] xl:text-3xl xl:py-3 xl:pl-3 xl:pr-15" type="email" name="email"
          placeholder="Email" required>
        <input class="text-xl py-1 pl-1 pr-5 bg-white rounded-md text-[#041368] xl:text-3xl xl:py-3 xl:pl-3 xl:pr-15" type="password" name="password"
    ...
    <div class="w-80 h-100 xl:w-120 xl:h-140 bg-slate-100 rounded-md flex justify-center items-center flex-col gap-4 xl:gap-8">
      ...
      <form action="" class="flex flex-col justify-center items-center gap-2 xl:gap-4">
        <div class="flex justify-center items-center gap-2.5">
          <input class="text-lg py-1 pl-1 w-30 bg-white rounded-md text-[#041368] xl:text-xl xl:py-3 xl:pl-3 xl:w-50" type="text" name="firstname"
            placeholder="First Name" required title="Please no digits or special caracteres">
          <input class="text-lg py-1 pl-1 w-30 bg-white rounded-md text-[#041368] xl:text-xl xl:py-3 xl:pl-3 xl:w-50" type="text" name="lasttname"
