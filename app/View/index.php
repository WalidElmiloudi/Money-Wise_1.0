...
<body class="w-full h-screen bg-slate-100 font-['open_sans'] overflow-hidden">
  <header class="fixed w-full flex items-center justify-between px-2 py-2 xl:-mt-10 xl:px-4">
    <img class="w-20 h-20 xl:w-40 xl:h-40" src="/Money-Wise%20_1.0/public/assets/img/Gemini_Generated_Image_9xkb4f9xkb4f9xkb.webp" alt="MONEYWISE logo">
  ...
  <section class="w-full h-screen flex flex-col justify-center items-center xl:flex-row xl:px-15 px-2 gap-6  ">
    <img class="xl:order-2 xl:w-200 xl:h-200 xl:-ml-60 xl:-mr-20 -mb-20 -mt-20 2xl:w-250 2xl:h-250 2xl:-mr-50" src="/Money-Wise%20_1.0/public/assets/img/Gemini_Generated_Image_9xkb4f9xkb4f9xkb.webp" alt="MONEYWISE logo">
  ...
  <section id="loginModal"
    ...
    <div class="w-80 h-100 xl:w-120 xl:h-140 bg-slate-100 rounded-md flex justify-center items-center flex-col gap-4 xl:gap-8">
      ...
      <form action="/Money-Wise_1.0//user/login" method="post" class="flex flex-col justify-center items-center gap-2 xl:gap-4">
  ...
  <section id="signupModal"
    ...
    <div class="w-80 h-100 xl:w-120 xl:h-140 bg-slate-100 rounded-md flex justify-center items-center flex-col gap-4 xl:gap-8">
      ...
      <form action="/Money-Wise_1.0/user/register" method="post" class="flex flex-col justify-center items-center gap-2 xl:gap-4">
