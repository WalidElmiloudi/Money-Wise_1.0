...
<body class="w-full h-screen flex flex-col bg-slate-200 font-['open_sans']">
  ...
  <section id="home" class="grid w-full h-full px-5 xl:px-2 grid-rows-8 xl:grid-cols-8 2xl:grid-cols-12 gap-2 xl:gap-4">
    ...
    <div
      class="xl:order-2 row-span-1 rounded-md bg-slate-300 shadow-md flex justify-center items-center xl:row-span-3 xl:col-span-4 2xl:col-span-7">
      <p class="text-3xl font-bold text-[#041368] 2xl:text-5xl">Welcome User !</p>
    </div>
    <div
      class="xl:order-4 row-span-3 rounded-md bg-slate-300 shadow-md flex justify-center items-center xl:row-span-5 xl:col-span-4 2xl:col-span-7">
      <div class="w-80 h-60 xl:w-[90%] xl:h-[85%] bg-slate-200">
    ...
    <div
      class="xl:order-3 row-span-4 rounded-md bg-slate-300 shadow-md flex flex-col justify-center items-center gap-5 xl:row-span-8 xl:col-span-2 2xl:col-span-3">
      <h1 class="text-2xl font-bold text-[#041368] 2xl:text-4xl">History</h1>
      <div class="w-[80%] h-[80%] xl:w-[85%] bg-slate-200">
      </div>
    </div>
  </section>
  <section id="menu"
